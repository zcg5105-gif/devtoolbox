...
export const toolRoutes = [
  { path: '/tool/json', name: 'JsonEditor', component: JsonEditor },
  { path: '/tool/timestamp', name: 'Timestamp', component: Timestamp },
  { path: '/tool/url', name: 'UrlCodec', component: UrlCodec },
  { path: '/tool/base64', name: 'Base64', component: Base64 },
  { path: '/tool/regex', name: 'RegexTester', component: RegexTester },
  { path: '/tool/cron', name: 'CronGenerator', component: CronGenerator },
  { path: '/tool/sql', name: 'SqlFormatter', component: SqlFormatter },
  { path: '/tool/qrcode', name: 'QrcodeTool', component: QrcodeTool },
  { path: '/tool/text-diff', name: 'TextDiff', component: TextDiff },
  { path: '/tool/code-obfuscator', name: 'CodeObfuscator', component: CodeObfuscator },
  { path: '/tool/markdown', name: 'MarkdownEditor', component: MarkdownEditor },
  { path: '/tool/http-client', name: 'HttpClient', component: HttpClient },
  { path: '/tool/jwt', name: 'JwtParser', component: JwtParser },
  ...
  { path: '/tool/date-calculator', name: 'DateCalculator', component: DateCalculator },
  { path: '/tool/json-schema', name: 'JsonSchema', component: JsonSchema },
  { path: '/tool/string-case', name: 'StringCaseConverter', component: StringCaseConverter },
  { path: '/tool/text-deduplicator', name: 'TextDeduplicator', component: TextDeduplicator },
  { path: '/tool/regex-reference', name: 'RegexReference', component: RegexReference },
  { path: '/tool/css-gradient', name: 'CssGradientGenerator', component: CssGradientGenerator },
  { path: '/tool/css-shadow', name: 'CssBoxShadowGenerator', component: CssBoxShadowGenerator },
  { path: '/tool/color-palette', name: 'ColorPalette', component: ColorPalette },
  { path: '/tool/csv-json', name: 'CsvJsonConverter', component: CsvJsonConverter },
  { path: '/tool/excel-compare', name: 'ExcelCompare', component: ExcelCompare },
  ...
  { path: '/tool/xml-json', name: 'XmlJsonConverter', component: XmlJsonConverter },
  { path: '/tool/hash', name: 'HashGenerator', component: HashGenerator },
  { path: '/tool/password', name: 'PasswordGenerator', component: PasswordGenerator },
  ...
  { path: '/tool/ip-lookup', name: 'IpLookup', component: IpLookup },
  { path: '/tool/user-agent', name: 'UserAgentParser', component: UserAgentParser },
  ...
  { path: '/tool/id-card', name: 'IdCardParser', component: IdCardParser },
  { path: '/tool/ascii-table', name: 'AsciiTable', component: AsciiTable },
  { path: '/tool/random', name: 'RandomGenerator', component: RandomGenerator },
  { path: '/tool/timer', name: 'Timer', component: Timer },
  { path: '/tool/unit-converter', name: 'UnitConverter', component: UnitConverter },
  { path: '/tool/sticky-notes', name: 'StickyNotes', component: StickyNotes },
...
const routeLoadersByPath = toolRoutes.reduce((loaders, route) => {
  loaders[route.path] = route.component
  return loaders
}, {})
...
export function preloadIdleRoutes() {
  ...
  const preload = () => {
    IDLE_PRELOAD_PATHS.forEach(path => {
